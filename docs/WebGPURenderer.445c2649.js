function e(e,t,a,r){Object.defineProperty(e,t,{get:a,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var a=globalThis.parcelRequire3fce,r=a.register;r("huPGn",function(t,a){e(t.exports,"localUniformBit",()=>r),e(t.exports,"localUniformBitGroup2",()=>o),e(t.exports,"localUniformBitGl",()=>f);let r={name:"local-uniform-bit",vertex:{header:`
        ...
        `}}}),r("kGDJh",function(t,a){e(t.exports,"textureBit",()=>r),e(t.exports,"textureBitGl",()=>o);let r={name:"texture-bit",vertex:{header:`
    ...
    `],n=0;for(let s=0;s<e.length;s++){let i=e[s],u=i.data.name,v=!1,l=0;for(let e=0;e<o.uniformParsers.length;e++)if(o.uniformParsers[e].test(i.data)){l=i.offset/4,f.push(`name = "${u}";`,`offset += ${l-n};`,o.uniformParsers[e][t]||o.uniformParsers[e].ubo),v=!0;break}if(!v)if(i.data.size>1)l=i.offset/4,f.push(a(i,l-n));else{let e=r[i.data.type];l=i.offset/4,f.push(`
                    v = uv.${u};
                    offset += ${l-n};
                    ${e};
                `)}n=l}return Function("uv","data","dataInt32","offset",f.join("\n"))}}),r("4OFSF",function(t,a){e(t.exports,"uniformParsers",()=>r);let r=[{type:"mat3x3<f32>",test:e=>void 0!==e.value.a,ubo:`
        ...
        `}]}),r("1nMtt",function(t,a){function r(e,t){return`
        for (let i = 0; i < ${e*t}; i++) {
